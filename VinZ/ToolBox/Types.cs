...
public static class Types
{
    ...
    public static Type[] From<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10>() => new Type[] { typeof(T1), typeof(T2), typeof(T3), typeof(T4), typeof(T5), typeof(T6), typeof(T7), typeof(T8), typeof(T9), typeof(T10) };
}