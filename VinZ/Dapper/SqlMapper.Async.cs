...
namespace Dapper
{
    public static partial class SqlMapper
    {
        ...
        public static Task<T?> QuerySingleOrDefaultAsync<T>(this IDbConnection cnn, string sql, object? param = null, IDbTransaction? transaction = null, int? commandTimeout = null, CommandType? commandType = null,
            ...
            QueryRowAsync<T?>(cnn, Row.SingleOrDefault, typeof(T), new CommandDefinition(sql, param, transaction, commandTimeout, commandType, CommandFlags.None, 
        ...
        public static Task<dynamic?> QuerySingleOrDefaultAsync(this IDbConnection cnn, string sql, object? param = null,
            CancellationToken? cancellationToken = default) =>
            QueryRowAsync<dynamic?>(cnn, Row.SingleOrDefault, typeof(DapperRow), new CommandDefinition(sql, param, null, null, null, CommandFlags.None, cancellationToken ?? CancellationToken.None));
        ...
        public static Task<dynamic?> QuerySingleOrDefaultAsync(this IDbConnection cnn, string sql, object? param = null, IDbTransaction? transaction = null, int? commandTimeout = null, CommandType? commandType = null,
            CancellationToken? cancellationToken = default) =>
            QueryRowAsync<dynamic?>(cnn, Row.SingleOrDefault, typeof(DapperRow), new CommandDefinition(sql, param, transaction, commandTimeout, commandType, CommandFlags.None, cancellationToken ?? CancellationToken.None));
        ...
        public static Task<int> ExecuteAsync(this IDbConnection cnn, string sql, object? param = null, IDbTransaction? transaction = null, int? commandTimeout = null, CommandType? commandType = null,
            CancellationToken? cancellationToken = default) =>
            ExecuteAsync(cnn, new CommandDefinition(sql, param, transaction, commandTimeout, commandType, CommandFlags.Buffered, 
                cancellationToken ?? CancellationToken.None));
        ...
        /// <returns>An enumerable of <typeparamref name="TReturn"/>.</returns>
        [System.Diagnostics.CodeAnalysis.SuppressMessage("ApiDesign", "RS0026:Do not add multiple public overloads with optional parameters", Justification = "Grandfathered")]
        public static Task<IEnumerable<TReturn>> QueryAsync<TReturn>(this IDbConnection cnn, string sql, CancellationToken? cancellationToken = default)
        {
                return QueryAsync<TReturn>(cnn, sql, null, null, null, null, true, "Id", null, null, cancellationToken.Value);
        }  
            ...
            CancellationToken? cancellationToken = default)
        {
            ...
            {
                return QueryAsync<TReturn>(cnn, typeof(TReturn),
                    new CommandDefinition(sql, param, transaction, commandTimeout, commandType, CommandFlags.Buffered, cancellationToken.Value));
            }
